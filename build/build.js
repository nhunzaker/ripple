...
"use strict";
var __moduleName = "collections/pings";
var Collection = require('backbone').Collection;
var Ping = require("../models/ping").Ping;
var Pings = function Pings(options) {
  $traceurRuntime.superCall(this, $Pings.prototype, "constructor", [options]);
  this.model = Ping;
};
var $Pings = Pings;
($traceurRuntime.createClass)(Pings, {
  initialize: function() {
    this.on('add', this.cull);
  },
  cull: function() {
    this.remove(this.filter((function(m) {
      return m.shouldDie();
    })));
  }
}, {}, Collection);
...
},{"../models/ping":3,"backbone":4}],2:[function(require,module,exports){
"use strict";
var __moduleName = "main";
var Backbone = require('backbone');
Backbone.$ = require('jquery');
var Pings = require('./collections/pings').Pings;
var Ripples = require('./views/ripples').Ripples;
...
"use strict";
var __moduleName = "models/ping";
var Model = require('backbone').Model;
var Ping = function Ping() {
  $traceurRuntime.defaultSuperCall(this, $Ping.prototype, arguments);
};
var $Ping = Ping;
($traceurRuntime.createClass)(Ping, {
  defaults: function() {
    return {
...
}).call(this,require("/Users/nathanielhunzaker/Learning/backbone_examples/ripples/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"/Users/nathanielhunzaker/Learning/backbone_examples/ripples/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":6}],8:[function(require,module,exports){
/*!
...
"use strict";
var __moduleName = "views/ripples";
var View = require('backbone').View;
var $ = require('jquery');
var Ripples = function Ripples() {
  $traceurRuntime.defaultSuperCall(this, $Ripples.prototype, arguments);
};
var $Ripples = Ripples;
($traceurRuntime.createClass)(Ripples, {
  events: function() {
